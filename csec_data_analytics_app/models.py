...
from django import VulnerabilyList

attack_vector: object = StringField(required=True, null=False)
    ...
    "definitions": {
        ...
        "cvss-v2": {
            "properties": {
                ...
                "cvssData": {"$ref": "//csrc.nist.gov/schema/nvd/api/2.0/external/cvss-v2.0.json"},
        ...
        "cvss-v31": {
            "properties": {
                "source": {"type": "string"},
                "type": {"enum": ["Primary", "Secondary"]},
                "cvssData": {"$ref": "//csrc.nist.gov/schema/nvd/api/2.0/external/cvss-v3.1.json"},
                "exploitabilityScore": {"$ref": "#/definitions/def_subscore"},
                "impactScore": {"$ref": "#/definitions/def_subscore"}
            },
            "required": ["source", "type", "cvssData"],
